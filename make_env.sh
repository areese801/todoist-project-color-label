...
## Define the showHelp() function
	showHelp(){
		...
		echo 
		echo "Example usage:"
		echo "\t. make_env.sh /path/to/somewhere/  <-- If not present at invocation, results in a virtual environment at '/path/to/somewhere/virtual_env'"
		echo "\t. make_env.sh /path/to/somewhere/ -f  <-- Results in a virtual environment at '/path/to/somewhere/virtual_env' even if one existed there previously"
	}
